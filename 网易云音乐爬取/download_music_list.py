...
class core():
    ...
    def work(self):
        ...
        # 获取id的值
        id_lists=[id.replace("/song?id=",'') for id in urls_list]
        d=Encrypyed()
        for id in id_lists:
            id=int(id)
...
if __name__ == '__main__':
    ...
    music_list_url='https://music.163.com/#/my/m/music/playlist?id=2464280481'
    # print(music_list_url)
    list_id = re.findall(r'(?<=id=)\S+', music_list_url)
